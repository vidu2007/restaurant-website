...
export default function RestaurantNavbar() {
  ...
  useEffect(() => {
    ...
    console.log(user, 'userState from navbar');
  }, [user])
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:block">
            <div className="ml-10 flex items-center space-x-8">
              ...
              <Link href={activeUser ? '/user' : '/sign-in'} className="bg-amber-600 hover:bg-amber-700 text-white px-6 py-2 rounded-full font-semibold transition-colors duration-200">
                {activeUser ? 'Profile' : 'Sign In' }
              </Link>
            </div>
          </div>
      ...
      {isMenuOpen && (
        <div className="lg:hidden bg-amber-900 border-t border-amber-800">
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <Link href={activeUser ? '/user' : '/sign-in' } className="block text-center w-full mt-2 bg-amber-600 hover:bg-amber-700 text-white px-6 py-2 rounded-full font-semibold transition-colors duration-200">
              {activeUser ? 'Profile' : 'Sign In' }
            </Link>
