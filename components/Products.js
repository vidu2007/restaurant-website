...
export default function Products() {
  ...
  return (
    <div className='flex flex-col gap-5'>
      ...
      <Link href='/menu' className="mx-auto mt-2 bg-amber-600 hover:bg-amber-700 text-white px-6 py-2 rounded-full font-semibold transition-colors duration-200">Explore more ...</Link>
    </div>
  )
}
