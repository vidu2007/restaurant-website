    ...
    <section>
        ...
        <form onSubmit={(e) => handleSubmit(e)} className='w-full lg:w-3/4 mx-auto px-9 py-8 md:text-2xl'>
            ...
            <div className="mb-4">
                ...
                <input type='number' onChange={(e) => setGuests(e.target.value)} required placeholder='1' min={1} max={20} id="Guests" name="Guests" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-white placeholder-text-white"/>
            </div>
