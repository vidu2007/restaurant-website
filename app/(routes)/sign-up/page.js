    ...
    <div>
        ...
        <form className='w-full lg:w-3/4 mx-auto px-9 py-8 md:text-2xl'>
            {/* <div className="mb-4">
                ...
                <input type="text" required placeholder='Lewis Hamilton' maxLength={30} id="ReservationName" name="ReservationName" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </div> */}
            ...
            <div className="mb-4">
                <button type='submit' onClick={(e) => handleSignUp(e)} className='w-full bg-amber-800 text-white px-4 py-2 rounded-md hover:bg-amber-900 transition-colors duration-300'>Sign-Up</button>
            </div>
        </form>
    </div>
  )
